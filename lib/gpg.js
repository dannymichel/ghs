        ...
        if (dryRun) {
            ...
            if (hard) {
                ...
                fingerprints.forEach(fingerprint => {
                    try {
                        if (execSync(`gpg --list-secret-keys "${fingerprint}"`).toString().trim()) {
                            ...
                            console.log(`Secret key with fingerprint ${fingerprint} not found`);
                        }
                        if (execSync(`gpg --list-keys "${fingerprint}"`).toString().trim()) {
                            console.log(`Attempting to delete public key with fingerprint ${fingerprint}`);
                            execSync(`gpg --batch --yes --delete-keys "${fingerprint}"`);
                        } else {
                            console.log(`Public key with fingerprint ${fingerprint} not found`);
                        }
                    } catch (error) {
